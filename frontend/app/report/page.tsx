          ...
          <div className="bg-gray-900 rounded-xl p-5 mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { label: `${dashboard.summary.partner_name || "Partner"} Mood`, value: dashboard.summary.partner_avg_mood },
                { label: "Your Avg Stress", value: dashboard.summary.my_avg_stress },
                { label: `${dashboard.summary.partner_name || "Partner"} Stress`, value: dashboard.summary.partner_avg_stress },
              ].map((stat, i) => (
