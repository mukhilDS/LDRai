...
export default function Dashboard() {
  ...
  const Slider = ({ label, key }: { label: string; key: keyof typeof checkin }) => (
    <div className="mb-4">
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white px-6 py-10 max-w-xl mx-auto">
      ...
      <div className="bg-gray-900 rounded-xl p-5 mb-6">
        ...
        <Slider label="Mood" key="mood" />
        <Slider label="Stress" key="stress" />
        <Slider label="Miss You" key="miss_you" />
      ...
      <div className="bg-gray-900 rounded-xl p-5 mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={handleJoinCouple}
            className="bg-pink-600 hover:bg-pink-700 px-4 rounded-lg text-sm transition">
            Join
          </button>
        </div>
      </div>
